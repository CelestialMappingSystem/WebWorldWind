 ...
 */
/**
 * @exports LROWACGlobalMosaicLayer
 */
define([
        '../geom/Location',
        '../geom/Sector',
    ...
    function (Location,
         ...
         * or undefined.
         */
        var LROWACGlobalMosaicLayer = function (layerName) {
            ...
            this.displayName = "LRO WAC Global Mosaic";
            this.pickEnabled = false;

            this.urlBuilder = new WmsUrlBuilder("https://planetarymaps.usgs.gov/cgi-bin/mapserv?map=/maps/earth/moon_simp_cyl.map",
                layerName || "LROC_WAC", "", "1.3.0");
        };

        LROWACGlobalMosaicLayer.prototype = Object.create(TiledImageLayer.prototype);

        return LROWACGlobalMosaicLayer;
    });