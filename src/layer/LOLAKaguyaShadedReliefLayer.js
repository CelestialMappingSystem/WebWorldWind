 ...
 */
/**
 * @exports LOLAKaguyaShadedReliefLayer
 */
define([
        '../geom/Location',
        '../geom/Sector',
    ...
    function (Location,
         ...
         * @alias LOLAKaguyaShadedReliefLayer
         * @constructor
         ...
         * or undefined.
         */
        var LOLAKaguyaShadedReliefLayer = function (layerName) {
            ...
            this.displayName = "Kaguya Shaded Relief";
            this.pickEnabled = false;

            this.urlBuilder = new WmsUrlBuilder("https://planetarymaps.usgs.gov/cgi-bin/mapserv?map=/maps/earth/moon_simp_cyl.map",
                layerName || "LOLA_Kaguya_Shade", "", "1.3.0");
        };

        LOLAKaguyaShadedReliefLayer.prototype = Object.create(TiledImageLayer.prototype);

        return LOLAKaguyaShadedReliefLayer;
    });